...
public:
	...
	int mTraceAdded;   // The amount by which this host has contributed to the global trace
...
#define MESSAGE_CONDITION_LEVELCOMPLETED   8
...
public:
	...
	// functions
#ifndef HE_EDITOR_BUILD
	int  targetMapAnimationStarted;
	void startTargetMapAnimation();
...
#ifndef HE_EDITOR_BUILD
	void UpdateMessages(heImage *pImage, heImage *pImage2);           // Updates in-level messages
